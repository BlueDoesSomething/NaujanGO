            ...
            {attractions.map((attraction, index) => (
              ...
              >
                ...
                <div className="hero-content">
                  ...
                  <p className="hero-description" style={{ color: slideshowSettings.descriptionColor || '#e5e7eb' }}>{attraction.description || 'Discover the beauty and wonder of this amazing destination.'}</p>
                  <button
            ...
            <div className="section-header">
              <div className="section-header-left">
                <div className="section-title-row">
                  ...
                  <h2 className="section-title">Featured Dining</h2>
                </div>
                <p className="section-subtitle">Culinary experiences from local restaurants</p>
              </div>
          ...
          <div className="container">
            <div className="section-header">
              <div className="section-header-left">
                <div className="section-title-row">
                  <Icons.Hotel size={24} />
                  <h2 className="section-title">Featured Accommodation</h2>
                </div>
                <p className="section-subtitle">Premium stays for your next getaway</p>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="accommodation-info">
                          ...
                          <p className="accommodation-price">From {formatCurrency(hotel.pricePerNight || 0, hotel.currency)}</p>
                        </div>
                      </div>
                    );
                  })}

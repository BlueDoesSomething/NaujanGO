...
// Test the CORRECT structure we discovered
const correctPayload = {
  data: {
    attributes: {
      type: 'gcash',  // NOT source_type!
...
console.log('📤 Testing CORRECTED GCash payload (type instead of source_type):');
